            ...
            describe("ascendingBackboneComparator", function () {
                ...
                it("should be somewhat robust", function () {
                    var myUndefinedPropertyNamesComparator = _.partial(ascendingBackboneComparator, undefined),
                        ...
                        myIllegalType1PropertyNamesComparator = _.partial(ascendingBackboneComparator, 3.14),
                        myIllegalType2PropertyNamesComparator = _.partial(ascendingBackboneComparator, [3.14, new Date()]),
