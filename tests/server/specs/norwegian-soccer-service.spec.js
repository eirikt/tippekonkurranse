...
var R = require('ramda'),
    isFunction = require('../../../shared/scripts/fun').isFunction,
...
describe('Norwegian Soccer Service', function () {
    ...
    describe('parseTippeligaTable', function () {
        ...
        it('should exist as a function', function () {
            ...
            expect(isFunction(norwegianSoccerService._parseAltOmFotballHtmlTable)).to.exist;
        });
    ...
    describe('parseTippeligaTopScorerTable', function () {
        ...
        it('should exist as a function', function () {
            ...
            expect(isFunction(norwegianSoccerService._parseTippeligaTopScorerTable)).to.exist;
        });
    ...
    describe('isEnabled', function () {
        it('should exist as a function', function () {
            ...
            expect(isFunction(norwegianSoccerService.isEnabled)).to.exist;
        });
    });
    ...
    describe('isValid', function () {
        it('should exist as a function', function () {
            ...
            expect(isFunction(norwegianSoccerService.isValid)).to.exist;
        });
    });
});
